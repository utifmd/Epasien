<?php 
    ...
    $queryjadwal = bukaquery(
        ...
        where dokter.status='1' ".(isset($keyword)?" and (dokter.nm_dokter like '%$keyword%' or jadwal.hari_kerja like '%$keyword%' or poliklinik.nm_poli like '%$keyword%')":"")." 
        order by jadwal.hari_kerja,jadwal.kd_dokter");
